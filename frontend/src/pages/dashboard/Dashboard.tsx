  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1A1D21] to-[#15171A]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <h2 className="text-2xl font-bold text-metal-text-light mb-6">진단 보조 도구</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-metal-text-light">증상 분석</h3>
            <p className="mt-2 text-sm text-metal-text-muted">
              환자 증상을 입력하여 AI 기반 진단 보조 분석을 수행합니다.
            </p>
            <div className="mt-4 text-xs text-accent-cyan opacity-70">
              BioBERT + XGBoost 앙상블
            </div>
          </Link>
          ...
          >
            <div className="text-3xl mb-3 opacity-80 group-hover:opacity-100 transition-opacity">🔬</div>
            <h3 className="text-lg font-semibold text-metal-text-light">이미지 분석</h3>
            <p className="mt-2 text-sm text-metal-text-muted">
              흉부 X-ray를 업로드하여 AI 분석 및 Grad-CAM 시각화를 수행합니다.
            </p>
            <div className="mt-4 text-xs text-accent-green opacity-70">
          ...
          >
            <div className="text-3xl mb-3 opacity-80 group-hover:opacity-100 transition-opacity">📚</div>
            <h3 className="text-lg font-semibold text-metal-text-light">문헌 검색</h3>
            <p className="mt-2 text-sm text-metal-text-muted">
              의학 문헌을 검색하고 RAG 기반 질의응답을 수행합니다.
            </p>
            <div className="mt-4 text-xs opacity-70" style={{ color: '#B39DDB' }}>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-metal-text-light">지식 그래프</h3>
            <p className="mt-2 text-sm text-metal-text-muted">
              의료 지식 그래프를 탐색하고 질환-증상-치료 관계를 시각화합니다.
            </p>
            <div className="mt-4 text-xs opacity-70" style={{ color: '#F5B041' }}>
        ...
        <div className="metal-card p-6 mb-8">
          <h3 className="text-lg font-semibold text-metal-text-light mb-4">시스템 상태</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 rounded-metal-sm"
              ...
              <div className="text-sm text-metal-text-muted">분석 모듈</div>
            </div>
            <div className="text-center p-4 rounded-metal-sm"
              style={{ background: 'linear-gradient(180deg, #252930 0%, #1F2328 100%)' }}>
              <div className="text-2xl font-bold text-accent-green">7</div>
              <div className="text-sm text-metal-text-muted">검출 가능 질환</div>
            </div>
            <div className="text-center p-4 rounded-metal-sm"
              style={{ background: 'linear-gradient(180deg, #252930 0%, #1F2328 100%)' }}>
              <div className="text-2xl font-bold" style={{ color: '#B39DDB' }}>8</div>
              <div className="text-sm text-metal-text-muted">문헌 DB</div>
            </div>
            <div className="text-center p-4 rounded-metal-sm"
              style={{ background: 'linear-gradient(180deg, #252930 0%, #1F2328 100%)' }}>
              ...
              <div className="text-sm text-metal-text-muted">API 상태</div>
            </div>
          </div>
        </div>
